...
$('.content').click(function(){
  if($('.sidebar').css('left') == '0px') toggleSidebar();
});
...
$('.incomes-table table').html(generateTable(incomesArray));
$('.expeses-table table').html(generateTable(expensesArray));
