...
<div class="modal fade deleteCategory" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body success-content" style="display:none;">
        <p class='alert alert-success'>Kategoria została usunięta.</p>
      </div>
      <div class="modal-body proper-content">
        ...
        <p class='e_db alert alert-danger' style="display:none;"></p>
      </div>
