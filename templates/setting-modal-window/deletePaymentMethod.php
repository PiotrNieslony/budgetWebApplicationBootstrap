...
<div class="modal fade deletePaymentMethod" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Usuwanie wydatku</h4>
      </div>
      ...
      <div class="modal-body proper-content">
        ...
        <p id="message2" >Wybierz metodę płatności ,dla wydatków przypisanych do usuwanej metody.</p>
        <div id="listOfPayentMethodModal" class="list-group ">
        </div>
