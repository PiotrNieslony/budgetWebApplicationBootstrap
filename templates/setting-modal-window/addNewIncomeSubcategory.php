...
<div class="modal fade addNewIncomeSubcategory" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Dodawanie nowej podkategorii</h4>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <?php
                  $budget->showIncomsCategory('addSubcategory');
                ?>
